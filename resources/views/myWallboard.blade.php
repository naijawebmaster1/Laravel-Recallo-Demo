                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Recallo Dashboard<div class="page-title-subheading">This Table shows the list Of All Recallo Users.</div></div>
                            </div>
...
function selectAUser(){
  ...
  icon: 'error',
  title: 'Oops...',
  text: 'You must select a User to see Wallboard',
         ...
         //   document.getElementById("usersCount").innerHTML = data.length;
            ...
            $.each(data, function(key, value){
                ...
                key = key+1;
                        ...
                        data = data + "<td>  <a href='./wallboard/" + value.id + "' class='edit'  ><i class='material-icons remove_red_eye'></i></a> </td>"
                        data = data + "</tr>"
