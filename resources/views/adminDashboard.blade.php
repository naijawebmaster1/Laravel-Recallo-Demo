                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Recallo Dashboard
                                    <div class="page-title-subheading">This Table shows the list Of All Recallo Users.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header">
                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal">
                                    <i class="header-icon lnr-charts icon-gradient bg-happy-green"> </i> System Statistics
                                </div>
                                <div class="btn-actions-pane-right text-capitalize">
                                  <a href="./users">  <button class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm">View
                                        All Users</button> </a>
                                </div>
                            </div>
                            <div class="no-gutters row">
                                <div class="col-sm-6 col-md-4 col-xl-4">
                                    <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                        ...
                                        <div class="widget-chart-content">
                                            ...
                                            <div class="widget-numbers" id="usersCount"><img width="40%" style="text-align: center;" src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif">
                                            </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-xl-4">
                                    <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                        ...
                                        <div class="widget-chart-content">
                                            ...
                                            <div class="widget-numbers"><span id="RecordsCount"><img width="40%"
                                                        style="text-align: center;"
                                                        src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif"></span>
                                            </div>
                                ...
                                <div class="col-sm-12 col-md-4 col-xl-4">
                                    <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                        ...
                                        <div class="widget-chart-content">
                                            ...
                                            <div class="widget-numbers text-success"><span><img width="40%"
                                                        style="text-align: center;"
                                                        src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif"></span>
                                            </div>
                            ...
                            <div class="text-center d-block p-3 card-footer">
                                <button class="btn-pill btn-shadow btn-wide fsize-1 btn btn-primary btn-lg">
                                    ...
                                    <span class="mr-1"><a style="color:#fff" href="./record">View Complete API Logs</a></span>
                                </button>
                            </div>
                        </div>
