                ...
                <div class="app-sidebar sidebar-shadow">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="#addEmployeeModal"  data-toggle='modal' onclick='editData({{ $data->id }})'>
                                    <i class="metismenu-icon pe-7s-display2"></i>Update API
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                ...
                                <div class="page-title-heading">
                                    <div>
                                        <div class="page-title-head center-elem">
                                            ...
                                            <span class="d-inline-block">Recallo User WallBoard for {{ $data->name }}</span>
                                        </div>
                                            ...
                                            <nav class="" aria-label="breadcrumb">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="active breadcrumb-item" aria-current="page">
                                                        Recallo Wallboard for {{ $data->name }}
                                                    </li>
                                                </ol>
                                            </nav>
                                        </div>
                                                ...
                                                <div class="widget-chart-content">
                                                    ...
                                                    <div class="widget-chart-flex">
                                                        <div class="widget-numbers mb-0 w-100">
                                                            <div class="widget-chart-flex">
                                                                <div class="fsize-4">
                                                                    <small class="opacity-5">.</small>{{ $data->Total_VOTP_Bought }}
                                                                </div>
                                                                <div class="ml-auto">
                                                        ...
                                                        <div class="widget-numbers mb-0 w-100">
                                                            <div class="widget-chart-flex">
                                                                <div class="fsize-4 text-danger">
                                                                    <small class="opacity-5 text-muted">.</small>{{ $data->Total_VOTP_Used }}
                                                                </div>
                                                                <div class="ml-auto">
                                                                    <div class="widget-title ml-auto font-size-lg font-weight-normal text-muted">
                                                        ...
                                                        <div class="widget-numbers mb-0 w-100">
                                                            <div class="widget-chart-flex">
                                                                <div class="fsize-4">
                                                                    ...
                                                                    <small class="opacity-5">.</small>{{ $data->Total_VOTP_Remaining }}
                                                                </div>
                                                                <div class="ml-auto">
                                                                    <div class="widget-title ml-auto font-size-lg font-weight-normal text-muted">
                                                ...
                                                <div class="widget-chart-content">
                                                    ...
                                                    <div class="widget-chart-flex">
                                                        <div class="widget-numbers mb-0 w-100">
                                                            <div class="widget-chart-flex">
                                                                <div class="fsize-4">
                                                                    <small class="opacity-5">.</small>{{ $data->VOTP_Dialing_MSISDN }}
                                                                </div>
                                                                <div class="ml-auto">
                                                                    <div class="widget-title ml-auto font-size-lg font-weight-normal text-muted">
                                                ...
                                                <div class="widget-chart-content">
                                                    <div class="widget-chart-flex">
                                                        <div class="widget-numbers mt-0">
                                                            <div class="widget-chart-flex">
                                                                <div>
                                                                    <small class="opacity-5">{{ $data->Customers_Listening_to_OTPs }}</small>
                                                                    <span>.</span>
                                                                </div>
                                        ...
                                        <div class="widget-content-outer">
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left pr-2 fsize-1">
                                                    <div class="widget-numbers mt-0 fsize-3 text-danger">{{ $data->Quick_VOTP_Activity_Reports_Today }}</div>
                                                </div>
                                            ...
                                            <div class="widget-content-left fsize-1">
                                                <div class="text-muted opacity-6">Quick_VOTP_Activity_Reports_Today</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-shadow-success mb-3 widget-chart widget-chart2 text-left card">
                                    <div class="widget-content p-0 w-100">
                                        <div class="widget-content-outer">
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left pr-2 fsize-1">
                                                    <div class="widget-numbers mt-0 fsize-3 text-success">{{ $data->Success_Rate_of_VOTP_today }}</div>
                                                </div>
                                                <div class="widget-content-right w-100">
                                                    <div class="progress-bar-xs progress">
    ...
    <div id="addEmployeeModal" class="modal fade">
            ...
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h4 class="modal-title" id="add-text">Add User API Details</h4>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Total_VOTP_Bought</label>
                <input type="text" class="form-control" id="Total_VOTP_Bought" required>
                <span class="text-danger" id="nameError"></span>
            </div>
            <div class="form-group">
                <label>Total_VOTP_Used</label>
                <input type="text" class="form-control" id="Total_VOTP_Used" required>
                <span class="text-danger" id="emailError"></span>

            </div>
            <div class="form-group">
                <label>
Total_VOTP_Remaining</label>
                <input type="text" class="form-control" id="Total_VOTP_Remaining" required>
                <span class="text-danger" id="passwordError"></span>


            </div>
            <div class="form-group">
                <label>VOTP_Dialing_MSISDN,
</label>
                <input type="text" class="form-control" id="VOTP_Dialing_MSISDN" required>
                <span class="text-danger" id="passwordError"></span>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Customers_Listening_to_OTPs</label>
                <input type="text" class="form-control" id="Customers_Listening_to_OTPs" required>
                <span class="text-danger" id="nameError"></span>
            </div>
            <div class="form-group">
                <label>Quick_VOTP_Activity_Reports_Today
</label>
                <input type="text" class="form-control" id="Quick_VOTP_Activity_Reports_Today" required>
                <span class="text-danger" id="emailError"></span>

            </div>
            <div class="form-group">
                <label>Success_Rate_of_VOTP_today</label>
                <input type="text" class="form-control" id="Success_Rate_of_VOTP_today" required>
                <span class="text-danger" id="passwordError"></span>


            </div>
            <div class="form-group">
                <!-- <label>Total_VOTP_API_Calls_Today</label> -->
                <input type="hidden" class="form-control" id="Total_VOTP_API_Calls_Today" required>
                <span class="text-danger" id="passwordError"></span>
...
console.log("You logged out successfully");
            ...
            if (id === 1) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#id').val(data.id);
                        $('#Total_VOTP_Bought').val(data.Total_VOTP_Bought);
                        $('#Total_VOTP_Used').val(data.Total_VOTP_Used);
                        $('#Total_VOTP_Remaining').val(data.Total_VOTP_Remaining);
                        $('#VOTP_Dialing_MSISDN').val(data.VOTP_Dialing_MSISDN);
                        $('#Customers_Listening_to_OTPs').val(data.Customers_Listening_to_OTPs);
                        $('#Quick_VOTP_Activity_Reports_Today').val(data.Quick_VOTP_Activity_Reports_Today);
                        $('#Success_Rate_of_VOTP_today').val(data.Success_Rate_of_VOTP_today);
                        $('#Total_VOTP_API_Calls_Today').val(data.Total_VOTP_API_Calls_Today);
                        $('#Total_VOTP_Delivered_Today').val(data.Total_VOTP_Delivered_Today);
        ...
        function updateData() {
            ...
            console.log('you arevtrying to update');
                   ...
                   var  id =     $('#id').val();
                   var  Total_VOTP_Bought =     $('#Total_VOTP_Bought').val();
                   var  Total_VOTP_Used =     $('#Total_VOTP_Used').val();
                    var  Total_VOTP_Remaining =     $('#Total_VOTP_Remaining').val();
            var  VOTP_Dialing_MSISDN =     $('#VOTP_Dialing_MSISDN').val();
            var  Customers_Listening_to_OTPs =     $('#Customers_Listening_to_OTPs').val();
            var  Quick_VOTP_Activity_Reports_Today =     $('#Quick_VOTP_Activity_Reports_Today').val();
            var  Success_Rate_of_VOTP_today =     $('#Success_Rate_of_VOTP_today').val();
            var  Total_VOTP_API_Calls_Today =     $('#Total_VOTP_API_Calls_Today').val();
            var  Total_VOTP_Delivered_Today =     $('#Total_VOTP_Delivered_Today').val();

              console.warn(id);
              console.warn(Total_VOTP_Bought);
              console.warn(Total_VOTP_API_Calls_Today);

            $.ajax({
                type: "POST",
                dataType: "json",
                data: {
                    Total_VOTP_Bought: Total_VOTP_Bought,
                    Total_VOTP_Used: Total_VOTP_Used,
                    Total_VOTP_Remaining: Total_VOTP_Remaining,
                     VOTP_Dialing_MSISDN: VOTP_Dialing_MSISDN,
                     Customers_Listening_to_OTPs: Customers_Listening_to_OTPs,
                     Quick_VOTP_Activity_Reports_Today: Quick_VOTP_Activity_Reports_Today,
                     Success_Rate_of_VOTP_today: Success_Rate_of_VOTP_today,
                     Total_VOTP_API_Calls_Today: Total_VOTP_API_Calls_Today,
                },

                url: "/user/updateAPI/" + id,
                ...
                success: function(data) {
                    ...
                    Swal.fire({
                        position: 'top-end',
                        icon: 'success',
                        title: 'API Data was Updated Successfully',
