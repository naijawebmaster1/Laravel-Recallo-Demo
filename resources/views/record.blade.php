                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                            <a onClick="logout()">                                    <i class="metismenu-icon pe-7s-display2"></i> Logout
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Recallo Dashboard
                                    <div class="page-title-subheading">This Table shows the list Of All Recallo API Calls.</div>
                                </div>
                            </div>
                    ...
                    <div class="tabs-animation">
                        ...
                        <div class="card mb-3">
                            <div class="card-header-tab card-header">
                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="header-icon lnr-laptop-phone mr-3 text-muted opacity-6"> </i>Recallo Dynamic Tables
                                </div>
                                <div class="btn-actions-pane-right actions-icon-btn">
                                    ...
                                    <button class="btn-wide btn-outline-2x mr-md-2 btn btn-outline-focus btn-sm" href="" class="btn btn-success" data-toggle="modal"   >...</button>
                                </div>
                            </div>
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img width="10%" style="text-align: center;" src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif"></td>
                                            <td><img width="10%" style="text-align: center;" src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif"></td>
                                            <td><img width="10%" style="text-align: center;" src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif"></td>
                                            <td><img width="10%" style="text-align: center;" src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif"></td>
                                            <td><img width="10%" style="text-align: center;" src="https://icons8.com/preloaders/preloaders/1484/Circles-menu-3.gif"></td>
...
key = key + 1;
                data = data + "<tr>"
                data = data + "<td>"+ key +"</td>"
                data = data + "<td>"+ value.uname +"</td>"
                data = data + "<td>"+ value.retry +"</td>"
                data = data + "<td>"+ value.apidt +"</td>"
                data = data + "<td>"+ value.num_dialed +"</td>"
                data = data + "</tr>"
